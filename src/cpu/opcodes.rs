...
lazy_static! {
    pub static ref CPU_OPS_CODES: Vec<OpCode> = vec![
        ...
        OpCode::new(0x1d, "ORA", 3, 4, AddressingMode::Absolute_X), // +1 page
        OpCode::new(0x19, "ORA", 3, 4, AddressingMode::Absolute_Y), // +1 page
        OpCode::new(0x01, "ORA", 2, 6, AddressingMode::Indirect_X),
        OpCode::new(0x11, "ORA", 2, 5, AddressingMode::Indirect_Y), // +1 page
        ...
        OpCode::new(0x1c, "TOP", 3, 4, AddressingMode::Absolute_X), // +1 page
        OpCode::new(0x3c, "TOP", 3, 4, AddressingMode::Absolute_X), // +1 page
        OpCode::new(0x5c, "TOP", 3, 4, AddressingMode::Absolute_X), // +1 page
        OpCode::new(0x7c, "TOP", 3, 4, AddressingMode::Absolute_X), // +1 page
        OpCode::new(0xdc, "TOP", 3, 4, AddressingMode::Absolute_X), // +1 page
        OpCode::new(0xfc, "TOP", 3, 4, AddressingMode::Absolute_X), // +1 page
