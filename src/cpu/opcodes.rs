...
lazy_static! {
    pub static ref CPU_OPS_CODES: Vec<OpCode> = vec![
        ...
        OpCode::new(0x0b, "AAC", 2, 2, AddressingMode::Immediate, true),
        OpCode::new(0x2b, "AAC", 2, 2, AddressingMode::Immediate, true),
        ...
        OpCode::new(0x7D, "ADC", 3, 4, AddressingMode::Absolute_X, false),//+1 page
        OpCode::new(0x79, "ADC", 3, 4, AddressingMode::Absolute_Y, false),//+1 page
        OpCode::new(0x61, "ADC", 2, 6, AddressingMode::Indirect_X, false),
        OpCode::new(0x71, "ADC", 2, 5, AddressingMode::Indirect_Y, false),//+1 page
        ...
        OpCode::new(0x3d, "AND", 3, 4, AddressingMode::Absolute_X, false),//+1 page
        OpCode::new(0x39, "AND", 3, 4, AddressingMode::Absolute_Y, false),//+1 page
        OpCode::new(0x21, "AND", 2, 6, AddressingMode::Indirect_X, false),
        OpCode::new(0x31, "AND", 2, 5, AddressingMode::Indirect_Y, false),//+1 page
        ...
        OpCode::new(0x1e, "ASL", 3, 7, AddressingMode::Absolute_X, false),//+1 page

        OpCode::new(0x4b, "ASR", 2, 2, AddressingMode::Immediate, true),

        OpCode::new(0xab, "ATX", 2, 2, AddressingMode::Immediate, true),

        OpCode::new(0x9f, "AXA", 3, 5, AddressingMode::Absolute_Y, true),
        OpCode::new(0x93, "AXA", 2, 6, AddressingMode::Indirect_Y, true),

        OpCode::new(0xcb, "AXS", 2, 2, AddressingMode::Immediate, true),

        OpCode::new(0x24, "BIT", 2, 3, AddressingMode::ZeroPage, false),
        OpCode::new(0x2C, "BIT", 3, 4, AddressingMode::Absolute, false),

        OpCode::new(0x90, "BCC", 2, 2, AddressingMode::Relative, false), //+1 if success, +2 if new page
        OpCode::new(0xb0, "BCS", 2, 2, AddressingMode::Relative, false), //+1 if success, +2 if new page
        OpCode::new(0xf0, "BEQ", 2, 2, AddressingMode::Relative, false), //+1 if success, +2 if new page
        OpCode::new(0x30, "BMI", 2, 2, AddressingMode::Relative, false), //+1 if success, +2 if new page
        OpCode::new(0xd0, "BNE", 2, 2, AddressingMode::Relative, false), //+1 if success, +2 if new page
        OpCode::new(0x10, "BPL", 2, 2, AddressingMode::Relative, false), //+1 if success, +2 if new page
        OpCode::new(0x50, "BVC", 2, 2, AddressingMode::Relative, false), //+1 if success, +2 if new page
        OpCode::new(0x70, "BVS", 2, 2, AddressingMode::Relative, false), //+1 if success, +2 if new page
        ...
        OpCode::new(0x58, "CLC", 1, 2, AddressingMode::NoneAddressing, false),
        ...
        OpCode::new(0xdd, "CMP", 3, 4, AddressingMode::Absolute_X, false), // +1 page
        OpCode::new(0xd9, "CMP", 3, 4, AddressingMode::Absolute_Y, false), // +1 page
        OpCode::new(0xc1, "CMP", 2, 6, AddressingMode::Indirect_X, false),
        OpCode::new(0xd1, "CMP", 2, 5, AddressingMode::Indirect_Y, false), // +1 page
        ...
        OpCode::new(0x04, "DOP", 2, 3, AddressingMode::ZeroPage, true),
        OpCode::new(0x14, "DOP", 2, 4, AddressingMode::ZeroPage_X, true),
        OpCode::new(0x34, "DOP", 2, 4, AddressingMode::ZeroPage_X, true),
        OpCode::new(0x44, "DOP", 2, 3, AddressingMode::ZeroPage, true),
        OpCode::new(0x54, "DOP", 2, 4, AddressingMode::ZeroPage_X, true),
        OpCode::new(0x64, "DOP", 2, 3, AddressingMode::ZeroPage, true),
        OpCode::new(0x74, "DOP", 2, 4, AddressingMode::ZeroPage_X, true),
        OpCode::new(0x80, "DOP", 2, 2, AddressingMode::Immediate, true),
        OpCode::new(0x82, "DOP", 2, 2, AddressingMode::Immediate, true),
        OpCode::new(0x89, "DOP", 2, 2, AddressingMode::Immediate, true),
        OpCode::new(0xc2, "DOP", 2, 2, AddressingMode::Immediate, true),
        OpCode::new(0xd4, "DOP", 2, 4, AddressingMode::ZeroPage_X, true),
        OpCode::new(0xe2, "DOP", 2, 2, AddressingMode::Immediate, true),
        OpCode::new(0xf4, "DOP", 2, 4, AddressingMode::ZeroPage_X, true),
        ...
        OpCode::new(0x5d, "EOR", 3, 4, AddressingMode::Absolute_X, false), // +1 page
        OpCode::new(0x59, "EOR", 3, 4, AddressingMode::Absolute_Y, false), // +1 page
        OpCode::new(0x41, "EOR", 2, 6, AddressingMode::Indirect_X, false),
        OpCode::new(0x51, "EOR", 2, 5, AddressingMode::Indirect_Y, false), // +1 page
        ...
        OpCode::new(0xf3, "ISB", 2, 8, AddressingMode::Indirect_Y, true),
        ...
        OpCode::new(0x02, "KIL", 1, 0, AddressingMode::NoneAddressing, true),
        OpCode::new(0x12, "KIL", 1, 0, AddressingMode::NoneAddressing, true),
        OpCode::new(0x22, "KIL", 1, 0, AddressingMode::NoneAddressing, true),
        OpCode::new(0x32, "KIL", 1, 0, AddressingMode::NoneAddressing, true),
        OpCode::new(0x42, "KIL", 1, 0, AddressingMode::NoneAddressing, true),
        OpCode::new(0x52, "KIL", 1, 0, AddressingMode::NoneAddressing, true),
        OpCode::new(0x62, "KIL", 1, 0, AddressingMode::NoneAddressing, true),
        OpCode::new(0x72, "KIL", 1, 0, AddressingMode::NoneAddressing, true),
        OpCode::new(0x92, "KIL", 1, 0, AddressingMode::NoneAddressing, true),
        OpCode::new(0xb2, "KIL", 1, 0, AddressingMode::NoneAddressing, true),
        OpCode::new(0xd2, "KIL", 1, 0, AddressingMode::NoneAddressing, true),
        OpCode::new(0xf2, "KIL", 1, 0, AddressingMode::NoneAddressing, true),

        OpCode::new(0xbb, "LAR", 3, 4, AddressingMode::Absolute_Y, true),

        OpCode::new(0xa7, "LAX", 2, 3, AddressingMode::ZeroPage, true),
        OpCode::new(0xb7, "LAX", 2, 4, AddressingMode::ZeroPage_Y, true),
        OpCode::new(0xaf, "LAX", 3, 4, AddressingMode::Absolute, true),
        OpCode::new(0xbf, "LAX", 3, 4, AddressingMode::Absolute_Y, true),
        OpCode::new(0xa3, "LAX", 2, 6, AddressingMode::Indirect_X, true),
        OpCode::new(0xb3, "LAX", 2, 5, AddressingMode::Indirect_Y, true),
        ...
        OpCode::new(0xbd, "LDA", 3, 4, AddressingMode::Absolute_X, false),//+1 page
        OpCode::new(0xb9, "LDA", 3, 4, AddressingMode::Absolute_Y, false),//+1 page
        OpCode::new(0xa1, "LDA", 2, 6, AddressingMode::Indirect_X, false),
        OpCode::new(0xb1, "LDA", 2, 5, AddressingMode::Indirect_Y, false),//+1 page
        ...
        OpCode::new(0x1d, "ORA", 3, 4, AddressingMode::Absolute_X, false), // +1 page
        OpCode::new(0x19, "ORA", 3, 4, AddressingMode::Absolute_Y, false), // +1 page
        OpCode::new(0x01, "ORA", 2, 6, AddressingMode::Indirect_X, false),
        OpCode::new(0x11, "ORA", 2, 5, AddressingMode::Indirect_Y, false), // +1 page
        ...
        OpCode::new(0xfd, "SBC", 3, 4, AddressingMode::Absolute_X, false),//+1 page
        OpCode::new(0xf9, "SBC", 3, 4, AddressingMode::Absolute_Y, false),//+1 page
        OpCode::new(0xe1, "SBC", 2, 6, AddressingMode::Indirect_X, false),
        OpCode::new(0xf1, "SBC", 2, 5, AddressingMode::Indirect_Y, false),//+1 page
        ...
        OpCode::new(0x9e, "SXA", 3, 5, AddressingMode::Absolute_Y, true),

        OpCode::new(0x9c, "SYA", 3, 5, AddressingMode::Absolute_X, true),
        ...
        OpCode::new(0x0c, "TOP", 3, 4, AddressingMode::Absolute, true),
        OpCode::new(0x1c, "TOP", 3, 4, AddressingMode::Absolute_X, true), // +1 page
        OpCode::new(0x3c, "TOP", 3, 4, AddressingMode::Absolute_X, true), // +1 page
        OpCode::new(0x5c, "TOP", 3, 4, AddressingMode::Absolute_X, true), // +1 page
        OpCode::new(0x7c, "TOP", 3, 4, AddressingMode::Absolute_X, true), // +1 page
        OpCode::new(0xdc, "TOP", 3, 4, AddressingMode::Absolute_X, true), // +1 page
        OpCode::new(0xfc, "TOP", 3, 4, AddressingMode::Absolute_X, true), // +1 page

        OpCode::new(0x8b, "XAA", 2, 2, AddressingMode::Immediate, true),

        OpCode::new(0x9b, "XAS", 3, 5, AddressingMode::Absolute_Y, true),
    ];
